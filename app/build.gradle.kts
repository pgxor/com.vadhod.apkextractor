...
// When it's absent (CI, other machines, debug-only work) the release build is simply left unsigned
// so nothing breaks. Never commit the keystore or its passwords.
...
android {
    namespace = "com.vadhod.apkextractor"
    compileSdk = 37
